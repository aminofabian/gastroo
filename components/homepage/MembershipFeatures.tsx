        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          ...
          >
            <h2 className="text-5xl md:text-6xl font-merriweather font-bold mb-8">
              <span className="inline-block bg-gradient-to-r from-white to-orange-200 bg-clip-text text-transparent">
                Empowering Gastroenterology
              </span>
              <br />
              <span className="inline-block bg-gradient-to-r from-orange-200 to-white bg-clip-text text-transparent">
                Excellence
              </span>
            </h2>
