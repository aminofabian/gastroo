...
const MembershipFeatures = () => {
  return (
    <section className="relative mt-40">
      ...
      {/* Main content */}
      <div className="bg-gradient-to-b from-[#c22f61] to-[#002347] pt-40 pb-32 relative">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="h-full bg-gradient-to-br from-white/[0.05] to-transparent p-1">
                  <div className="relative h-full bg-gradient-to-br from-[#c22f61]/40 to-[#002347]/40 backdrop-blur-sm p-8">
